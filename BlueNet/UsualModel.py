...
ResNet18 = 	[
			...
			ResLayer([Conv({'f_num':64, 'f_size':3, 'pad':1, 'stride':1}),
						Conv({'f_num':64, 'f_size':3, 'pad':1, 'stride':1})]),
			ResLayer([Conv({'f_num':64, 'f_size':3, 'pad':1, 'stride':1}),
						Conv({'f_num':64, 'f_size':3, 'pad':1, 'stride':1})]),

			ResLayer([Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':2}),
						Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1})]),
			ResLayer([Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1}),
						Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1})]),
			
			ResLayer([Conv({'f_num':256, 'f_size':3, 'pad':1, 'stride':2}),
						Conv({'f_num':256, 'f_size':3, 'pad':1, 'stride':1})]),
			ResLayer([Conv({'f_num':256, 'f_size':1, 'pad':0, 'stride':1}),
						Conv({'f_num':256, 'f_size':3, 'pad':1, 'stride':1})]),
			
			ResLayer([Conv({'f_num':512, 'f_size':3, 'pad':1, 'stride':2}),
						Conv({'f_num':512, 'f_size':3, 'pad':1, 'stride':1})]),
			ResLayer([Conv({'f_num':512, 'f_size':1, 'pad':0, 'stride':1}),
						Conv({'f_num':512, 'f_size':3, 'pad':1, 'stride':1})]),
...
ResNet50 = 	[
			...
			ResLayer([Conv({'f_num':64, 'f_size':1, 'pad':0, 'stride':1}),
						Conv({'f_num':64, 'f_size':3, 'pad':1, 'stride':1}),
			...
			ResLayer([Conv({'f_num':128, 'f_size':1, 'pad':0, 'stride':2}),
						Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1}),
						Conv({'f_num':512, 'f_size':1, 'pad':0, 'stride':1})]),
			ResLayer([Conv({'f_num':128, 'f_size':1, 'pad':0, 'stride':1}),
						Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1}),
						Conv({'f_num':512, 'f_size':1, 'pad':0, 'stride':1})]),
			ResLayer([Conv({'f_num':128, 'f_size':1, 'pad':0, 'stride':1}),
						Conv({'f_num':128, 'f_size':3, 'pad':1, 'stride':1}),
			...
			ResLayer([Conv({'f_num':256, 'f_size':1, 'pad':0, 'stride':2}),
						Conv({'f_num':256, 'f_size':3, 'pad':1, 'stride':1}),
			...
			ResLayer([Conv({'f_num':512, 'f_size':1, 'pad':0, 'stride':2}),
						Conv({'f_num':512, 'f_size':3, 'pad':1, 'stride':1}),
